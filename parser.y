...
%type <stmtval> stmt stmts  ifstmt whilestmt forstmt returnstmt break continue 
...
whilestmt: 	whilestart whilecond stmt {make_stmt(&$stmt);} {
                    gloop--;
...
forstmt:	forprefix N elist R_PAR N stmt {make_stmt(&$stmt); gloop--;} N  {
