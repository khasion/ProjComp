...
static const yytype_uint16 yyrline[] =
{
     ...
     126,   136,   146,   156,   166,   176,   186,   194,   202,   205,
     206,   213,   218,   234,   251,   267,   284,   287,   304,   305,
     306,   307,   311,   314,   319,   327,   332,   335,   336,   342,
     343,   346,   347,   356,   363,   364,   367,   373,   379,   383,
     385,   389,   392,   402,   414,   415,   418,   422,   423,   426,
     426,   429,   434,   440,   451,   457,   464,   465,   467,   477,
     478,   479,   480,   481,   482,   485,   486,   487,   490,   497,
     503,   506,   512,   518,   526,   534,   535,   537,   539,   544,
     547,   547,   554,   554,   565,   567,   570,   573
};
#endif
...
#line 126 "parser.y" /* yacc.c:1646  */
    {
        		...
        		(yyval.exprval)->sym = newtemp();
						(yyval.exprval)->truelist=makelist(nextquad());
						(yyval.exprval)->falselist=makelist(nextquad()+1);
...
#line 136 "parser.y" /* yacc.c:1646  */
    {
        		...
        		(yyval.exprval)->sym = newtemp();
						(yyval.exprval)->truelist=makelist(nextquad());
						(yyval.exprval)->falselist=makelist(nextquad()+1);
        		emit(if_greatereq, (yyvsp[-2].exprval), (yyvsp[0].exprval), NULL, nextquad()+3, yylineno);
        		//emit(assign, newexpr_constbool('0'), NULL, $<exprval>$, 69,yylineno);
        		emit(jump, NULL, NULL, NULL , nextquad()+2, yylineno);
        		//emit(assign, newexpr_constbool('1'), NULL, $<exprval>$, 69 , yylineno);
        	}
...
#line 146 "parser.y" /* yacc.c:1646  */
    {
        		...
        		(yyval.exprval)->sym = newtemp();
						(yyval.exprval)->truelist=makelist(nextquad());
						(yyval.exprval)->falselist=makelist(nextquad()+1);
        		emit(if_less, (yyvsp[-2].exprval), (yyvsp[0].exprval), NULL, nextquad()+3, yylineno);
        		//emit(assign, newexpr_constbool('0'), NULL, $<exprval>$, 69,yylineno);
        		emit(jump, NULL, NULL, NULL , nextquad()+2, yylineno);
        		//emit(assign, newexpr_constbool('1'), NULL, $<exprval>$, 69 , yylineno);
      	}
...
#line 156 "parser.y" /* yacc.c:1646  */
    {
        		...
        		(yyval.exprval)->sym = newtemp();
						(yyval.exprval)->truelist=makelist(nextquad());
						(yyval.exprval)->falselist=makelist(nextquad()+1);
        		emit(if_lesseq, (yyvsp[-2].exprval), (yyvsp[0].exprval), NULL, nextquad()+3, yylineno);
        		//emit(assign, newexpr_constbool('0'), NULL, $<exprval>$, 69,yylineno);
        		emit(jump, NULL, NULL, NULL , nextquad()+2, yylineno);
        		//emit(assign, newexpr_constbool('1'), NULL, $<exprval>$, 69 , yylineno);
      	}
...
#line 166 "parser.y" /* yacc.c:1646  */
    {
        		...
        		(yyval.exprval)->sym = newtemp();
						(yyval.exprval)->truelist=makelist(nextquad());
						(yyval.exprval)->falselist=makelist(nextquad()+1);
        		emit(if_eq, (yyvsp[-2].exprval), (yyvsp[0].exprval), NULL, nextquad()+3, yylineno);
        		//emit(assign, newexpr_constbool('0'), NULL, $<exprval>$, 69,yylineno);
        		emit(jump, NULL, NULL, NULL , nextquad()+2, yylineno);
        		//emit(assign, newexpr_constbool('1'), NULL, $<exprval>$, 69 , yylineno);
      	}
...
#line 186 "parser.y" /* yacc.c:1646  */
    {
       	...
       	(yyval.exprval) = newexpr(boolexpr_e);
        (yyval.exprval)->sym = newtemp();
        emit(op_and,(yyvsp[-3].exprval), (yyvsp[-1].exprval), (yyval.exprval), 69, yylineno);
      	}
...
#line 194 "parser.y" /* yacc.c:1646  */
    {
        	...
        	(yyval.exprval) = newexpr(boolexpr_e);
        	(yyval.exprval)->sym = newtemp();
        	emit(op_or ,(yyvsp[-3].exprval), (yyvsp[-1].exprval), (yyval.exprval), 69, yylineno);
      	}
